...
export const apps: App[] = [
  ...
  },
  {
    ...
    longDescription:
      "Браузерный редактор музыки: обрезка и склейка треков, скорость и эквалайзер по участку, fade in/out, crossfade и подготовка программ для фигурного катания. Экспорт MP3 и WAV. Вся обработка в браузере.",
