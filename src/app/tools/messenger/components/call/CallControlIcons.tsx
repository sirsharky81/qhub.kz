...
export function FlipCameraIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <path d="M7 7h2l1.2-2h3.6L15 7h2a2 2 0 012 2v7a2 2 0 01-2 2H7a2 2 0 01-2-2V9a2 2 0 012-2z" />
      <path d="M9 12a3 3 0 015-2.2M15 12a3 3 0 01-5 2.2" />
      <path d="M14 8.8v2.4h-2.4M10 15.2v-2.4h2.4" />
    </svg>
  );
}

export function ScreenShareIcon({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" stroke="currentColor" strokeWidth="2" aria-hidden>
      <rect x="3" y="4" width="18" height="13" rx="2" />
      <path d="M8 21h8M12 17v4M12 13V8M9.5 10.5L12 8l2.5 2.5" />
    </svg>
  );
}
