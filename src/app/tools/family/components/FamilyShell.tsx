...
export function FamilyShell({ title, subtitle, backHref, trailing, children, fullWidth }: Props) {
  return (
    <div className="flex flex-col h-[100dvh] max-h-[100dvh] overflow-hidden bg-slate-200/60 text-gray-900">
      <div
        className={`flex flex-col h-full w-full min-w-0 mx-auto overflow-hidden ${
          fullWidth ? "" : "max-w-lg"
