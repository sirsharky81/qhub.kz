...
import type { QrGenerationResult } from "@/lib/qr-generator/types";
...
export function QRPreview({ result, generating, printCaption }: QRPreviewProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div
        id="qr-print-area"
        className="relative flex flex-col items-center justify-center rounded-xl border border-gray-200 bg-white p-6 min-h-[240px] w-full"
      >
        {generating && (
        ...
        {result.dataUrl ? (
          <>
            ...
            <img
              src={result.dataUrl}
              alt="QR code preview"
              width={Math.min(result.dataUrl ? 280 : 0, 280)}
              height={280}
      ...
      {result.decodeOk === true && result.dataUrl && (
